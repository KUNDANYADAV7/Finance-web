...
//     categories: [
//       { id: '1', name: 'Housing', allocated: 0, spent: 0, required: true },
//       { id: '2', name: 'Food', allocated: 0, spent: 0, required: true },
//       { id: '3', name: 'Transportation', allocated: 0, spent: 0, required: true },
//       { id: '4', name: 'Entertainment', allocated: 0, spent: 0, required: false },
//       { id: '5', name: 'Utilities', allocated: 0, spent: 0, required: false }
//     ]
//   });
...
//     if (hasEmptyRequired) {
//       setValidationError('The first three categories (Housing, Food, and Transportation) are mandatory.');
//       return;
//     }
...
//       updateBudgetCategory(selectedBudgetId, selectedCategory);
...
//     ? selectedBudget.categories.reduce((sum, category) => sum + category.allocated, 0)
//     : 0;
  
//   const totalSpent = selectedBudget
//     ? selectedBudget.categories.reduce((sum, category) => sum + category.spent, 0)
//     : 0;
...
//                         onChange={(e) => setNewBudgetData({ ...newBudgetData, year: parseInt(e.target.value) || new Date().getFullYear() })}
//                         className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//                         required
//                       />
//                     </div>
...
//                           ₹{budget.categories.reduce((sum, cat) => sum + cat.allocated, 0).toFixed(2)}
//                         </span>
//                       </div>
//                       <div className="flex justify-between text-sm">
...
//                           </span> 
//                           <span className="text-gray-500"> / ₹{category.allocated.toFixed(2)}</span>
//                         </div>
//                       </div>
